...
class Residencia(db.Model):
    ...
    def __repr__(self):
        return
        f"<Residencia: {self.id}, {self.nombre}, {self.direccion}, "
        "{self.no_habitaciones}, {self.director}>"
...
class Paciente(db.Model):
    ...
    def __repr__(self):
        return
        f"<Paciente : {self.dni}, {self.nombre}, {self.apellido}, "
        "{self.edad}, f{self.residencia}, {self.usuario}>"
